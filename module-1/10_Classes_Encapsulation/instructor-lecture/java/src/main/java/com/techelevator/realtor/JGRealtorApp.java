...
public class JGRealtorApp {
	...
	public static void main(String[] args) {
		...
		//  CAUTION:  The following is a HOT MESS!  We need to clean this Tightly coupled crap up before anyone sees us!
        ...
        searchAddress.setCity("Lewis Center");
        
        for (House h : agentOnesList) {
        	
        	System.out.println(h.toString());
        	
        	if (h.getAddress().getCity().equals(searchAddress.getCity())) { 
        		//found
        	}
        ...
        homeInventory.addHouseToInventory(house2);
        homeInventory.removeHouseFromInventory(mlsNumber);
        homeInventory.retrieveHomesByZipCode("43026")
