...
public class LocationService {
    ...
    public Location add(String CSV) {
    	...
    	headers.setContentType(MediaType.APPLICATION_JSON); //server api will document required/optional header information - in this case we want JSON
    	
    	HttpEntity<Location> entity = new HttpEntity(location, headers);		//package of our data and header info
    	
    	location = restTemplate.postForObject(BASE_URL + "locations/" + location.getId(), entity, Location.class);
